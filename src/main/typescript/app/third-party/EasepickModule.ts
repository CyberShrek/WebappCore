...
export class EasepickModule extends InputModule<EasepickValue>{
    ...
    private easepickDetailToCalendarValue(detail: any): EasepickValue{
        return this.config.range
            ? {date: stringifyDate(detail.start), dateEnd: stringifyDate(detail.end)}
            : {date: stringifyDate(detail.date)}
    }
}